...
var listing = {
                    ...
                    async.parallel([
                        ...
                        function (callback) {
                            ...
                            async.forEach(vendors, function (eachvendor, callback) {
                                ...
                                vendor.listing_number = eachvendor.listing_number,
                        ...
                        res.render('listings', {
                            ...
                            page_data: {pages: pages, first: pages.first, last: pages.last}
                        });
        ...
        if (vendor_id !== undefined) {
            async.parallel([
                ...
                function (callback) {
                    ...
                    mongo.getVendorListings(query, projection, function (err, Vendorlistings) {
                ...
                function(callback){
                    ...
                    mysqlDB.getVendorById(vendor_id,function(err,details){

                        if(err)
                            callback(err)
                        else {
                            vendor_details.name = details.name;
                            vendor_details.number = details.contact_no;
                            vendor_details.email = details.email;
                            vendor_details.id = details.id;
                            vendor_details.status = details.status;
                            callback();
                        }
    ...
    viewListing: function (req, res, next) {

        var listing_id = req.query.id || undefined;
